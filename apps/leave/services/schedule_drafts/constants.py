...
AUTO_DRAFT_PERSISTED_PACKAGE_ALTERNATIVES = 3
AUTO_DRAFT_GLOBAL_TOP_PACKAGES_PER_EMPLOYEE = 2
AUTO_DRAFT_GLOBAL_BEAM_WIDTH = 6
AUTO_DRAFT_GLOBAL_MAX_GROUP_EMPLOYEES = 6
MANUAL_DRAFT_MAX_PACKAGE_PERIODS = 3
MANUAL_DRAFT_MAX_PACKAGE_SUGGESTIONS = 48
MANUAL_DRAFT_VISIBLE_PACKAGE_SUGGESTIONS = 10
MANUAL_DRAFT_SUGGESTION_CANDIDATES_PER_STRATEGY = 4
MANUAL_DRAFT_SUGGESTION_SEED_MULTIPLIER = 1
MANUAL_DRAFT_SUGGESTION_CACHE_SCHEMA_VERSION = 5
